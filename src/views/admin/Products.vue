...
import DialogAdminProduct from "@/components/DialogAdminProduct.vue";

const loading = ref(false);
const currentPage = ref(1);
const dialogAdminProduct = useTemplateRef("dialogAdminProduct");
const data = ref([]);
const total = ref();
        ...
        try {
          ...
          if (result.success) {
            ...
            if (response?.success && response.products) {
              const pageHasData = response.products.length > 0;
